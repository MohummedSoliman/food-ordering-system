...
import com.mohamed.payment.service.domain.exception.PaymentNotFoundException;
        ...
        messages.forEach(paymentRequestAvroModel -> {
            try {
                ...
                if (sqlException != null && sqlException.getSQLState() != null &&
                    ...
                    // NO-OP
                    log.error("Caught unique constraint exception with sql");
                } else {
                    throw new PaymentApplicationServiceException(
                            "Throwing DataAccessException in PaymentRequestKafkaListener: " +
                                    e.getMessage(), e
                    );
                }
